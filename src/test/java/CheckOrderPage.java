...
import static Elements.SingleElements.*;
...
public class CheckOrderPage {
    ...
    public CheckOrderPage(By button, By checkText, String expected) {
        this.button = button;
    ...
    public void headersTest() {
        ...
        singleElements.scrollUntilElement(By.xpath(".//div[text()='Вопросы о важном']"));
//          new WebDriverWait(driver, Duration.ofSeconds(50)).until(ExpectedConditions.elementToBeClickable(By.xpath(".//div[text()='Вопросы о важном']")));
        singleElements.clickArrowOne(button);
        assertEquals(expected, singleElements.getTextOfFirstArrow(checkText));
    }
